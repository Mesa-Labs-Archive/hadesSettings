...
import com.mesalabs.hadesrc.activity.aboutpage.CreditsActivity;
...
public class CreditsPageListItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int getChildCount(RecyclerView recyclerView) {
        ...
        if (!((CreditsPageListViewHolder) recyclerView.findViewHolderForLayoutPosition(llm.findLastVisibleItemPosition())).getIsItem()) {
