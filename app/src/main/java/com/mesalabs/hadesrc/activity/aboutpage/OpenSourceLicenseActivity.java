...
public class OpenSourceLicenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hades_rc_layout_opensourcelicenseactivity);

        mToolbarLayout = findViewById(R.id.hades_opensourcelicenseactivity_toolbarlayout);
        ...
        mWebView = findViewById(R.id.hades_opensourcelicenseactivity_webview);
        ...
        if (SeslMisc.isLightTheme(this)) {
            ...
            data.append("<html><head><style type=\"text/css\">body{color: #ffffff; background-color: #171717;}</style></head><body>");
